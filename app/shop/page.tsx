...
export const metadata: Metadata = {
  title: 'Shop | RunExpression',
  description:
    'Gear, apparel, and goods for expressive runners. Shop coming soon.',
}
      ...
      <section className="border-b border-border bg-gradient-to-b from-muted/50 to-background pb-8 pt-12 md:pb-12 md:pt-20">
        <div className="container">
          ...
          <p className="max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
            Gear, apparel, and goods for expressive runners.
          </p>
        </div>
      </section>
      ...
      <section className="container py-16 md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mb-8 text-lg text-muted-foreground">
            We&apos;re preparing greeting cards, apparel, and goods that
            celebrate the expressive runner lifestyle. Check back soon.
          </p>
