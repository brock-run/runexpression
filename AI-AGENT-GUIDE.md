...
*[Full details in docs/RECOMMENDATIONS.md]*
...
These skills are available in Cursor IDE. Each skill provides specialized knowledge for specific domains.

### clubhouse-patterns

**Description:** Use when: implementing clubhouse features, upload workflows, media galleries, lore stories, or club-specific functionality

**File:** `.cursor/skills/clubhouse-patterns/SKILL.md`

*[Full skill documentation in .cursor/skills/clubhouse-patterns/SKILL.md]*

---

### content-moderation-trust-systems

**Description:** Use when: implementing Flow submission moderation, clubhouse upload approval workflows, building admin tools, handling edge cases in moderation, or integrating content filtering and validation

**File:** `.cursor/skills/content-moderation-trust-systems/SKILL.md`

*[Full skill documentation in .cursor/skills/content-moderation-trust-systems/SKILL.md]*

---

### database-schema-migration

**Description:** Use when: adding new features requiring database changes, optimizing query performance, creating seed data for development/testing, or planning schema evolution

**File:** `.cursor/skills/database-schema-migration/SKILL.md`

*[Full skill documentation in .cursor/skills/database-schema-migration/SKILL.md]*

---

### flow-feature-patterns

**Description:** Use when: implementing Flow features, vibe tag filtering, moderation queues, real-time updates, or Flow submission flows

**File:** `.cursor/skills/flow-feature-patterns/SKILL.md`

*[Full skill documentation in .cursor/skills/flow-feature-patterns/SKILL.md]*

---

### framer-motion-animation

**Description:** Use when: creating scroll-triggered animations (manifesto chapters), stagger animations for lists, shared element transitions, modal/dialog transitions, Flow wall entry animations, or any motion-heavy features

**File:** `.cursor/skills/framer-motion-animation/SKILL.md`

*[Full skill documentation in .cursor/skills/framer-motion-animation/SKILL.md]*

---

### git-workflow-conventional-commits

**Description:** Use when: setting up project Git standards, reviewing commit history, creating PR templates, configuring Husky hooks, writing commit messages, creating branches, or when the user asks about Git workflow, conventional commits, branch naming, or PR guidelines

**File:** `.cursor/skills/git-workflow-conventional-commits/SKILL.md`

*[Full skill documentation in .cursor/skills/git-workflow-conventional-commits/SKILL.md]*

---

### nextjs-app-router-specialist

**Description:** Use when: setting up new routes and layouts, optimizing page performance, implementing SSR/SSG strategies, or debugging Next

**File:** `.cursor/skills/nextjs-app-router-specialist/SKILL.md`

*[Full skill documentation in .cursor/skills/nextjs-app-router-specialist/SKILL.md]*

---

### runexpression-brand-voice

**Description:** Use when: writing any user-facing text, creating content, reviewing brand voice, generating seed content, or ensuring brand consistency

**File:** `.cursor/skills/runexpression-brand-voice/SKILL.md`

*[Full skill documentation in .cursor/skills/runexpression-brand-voice/SKILL.md]*

---

### shadcn-ui-component-builder

**Description:** Use when: building new UI components, customizing existing Shadcn components, ensuring accessibility compliance, or implementing brand-specific visual patterns (sage green, purple glows, monospace fonts)

**File:** `.cursor/skills/shadcn-ui-component-builder/SKILL.md`

*[Full skill documentation in .cursor/skills/shadcn-ui-component-builder/SKILL.md]*

---

### stripe-payment-integration

**Description:** Use when: implementing shop features, payment flows, webhook handlers, order management, digital product delivery, or debugging Stripe integration issues

**File:** `.cursor/skills/stripe-payment-integration/SKILL.md`

*[Full skill documentation in .cursor/skills/stripe-payment-integration/SKILL.md]*

---

### supabase-integration-expert

**Description:** Use when: creating new database tables and policies, implementing real-time features (Flow wall updates), setting up file uploads, debugging RLS policy issues, or optimizing database queries

**File:** `.cursor/skills/supabase-integration-expert/SKILL.md`

*[Full skill documentation in .cursor/skills/supabase-integration-expert/SKILL.md]*

---

### testing-qa-automation

**Description:** Use when: adding tests for new features, setting up test infrastructure, debugging test failures, or configuring CI/CD test pipelines

**File:** `.cursor/skills/testing-qa-automation/SKILL.md`

*[Full skill documentation in .cursor/skills/testing-qa-automation/SKILL.md]*

---

### typescript-type-safety

**Description:** Use when: adding new features requiring type definitions, refactoring for better type safety, generating database types after schema changes, debugging type errors, or working with JSONB, unions, generics, or type-safe API routes

**File:** `.cursor/skills/typescript-type-safety/SKILL.md`

*[Full skill documentation in .cursor/skills/typescript-type-safety/SKILL.md]*
...
These agents coordinate multiple skills for specific workflows.
...
**File:** `.cursor/agents/backend-database-agent.md`

*[Full agent documentation in .cursor/agents/backend-database-agent.md]*
...
**File:** `.cursor/agents/content-brand-agent.md`

*[Full agent documentation in .cursor/agents/content-brand-agent.md]*
...
**File:** `.cursor/agents/devops-deployment-agent.md`

*[Full agent documentation in .cursor/agents/devops-deployment-agent.md]*
...
**File:** `.cursor/agents/frontend-development-agent.md`

*[Full agent documentation in .cursor/agents/frontend-development-agent.md]*
...
**File:** `.cursor/agents/full-stack-feature-agent.md`

*[Full agent documentation in .cursor/agents/full-stack-feature-agent.md]*
...
**File:** `.cursor/agents/testing-qa-agent.md`

*[Full agent documentation in .cursor/agents/testing-qa-agent.md]*
...
These skills are converted from Cursor skills for use with Claude Code.
...
**File:** `.claude/skills/content-moderation-trust-systems/SKILL.md`

*[Full skill documentation in .claude/skills/content-moderation-trust-systems/SKILL.md]*
...
**File:** `.claude/skills/database-schema-migration/SKILL.md`

*[Full skill documentation in .claude/skills/database-schema-migration/SKILL.md]*
...
**File:** `.claude/skills/framer-motion-animation/SKILL.md`

*[Full skill documentation in .claude/skills/framer-motion-animation/SKILL.md]*
...
**File:** `.claude/skills/git-workflow-conventional-commits/SKILL.md`

*[Full skill documentation in .claude/skills/git-workflow-conventional-commits/SKILL.md]*

---

### nextjs-app-router-specialist

**Description:** Use when: setting up new routes and layouts, optimizing page performance, implementing SSR/SSG strategies, debugging Next

**File:** `.claude/skills/nextjs-app-router-specialist/SKILL.md`

*[Full skill documentation in .claude/skills/nextjs-app-router-specialist/SKILL.md]*
...
**File:** `.claude/skills/shadcn-ui-component-builder/SKILL.md`

*[Full skill documentation in .claude/skills/shadcn-ui-component-builder/SKILL.md]*
...
**File:** `.claude/skills/stripe-payment-integration/SKILL.md`

*[Full skill documentation in .claude/skills/stripe-payment-integration/SKILL.md]*
...
**File:** `.claude/skills/supabase-integration-expert/SKILL.md`

*[Full skill documentation in .claude/skills/supabase-integration-expert/SKILL.md]*
...
**File:** `.claude/skills/testing-qa-automation/SKILL.md`

*[Full skill documentation in .claude/skills/testing-qa-automation/SKILL.md]*
...
**File:** `.claude/skills/typescript-type-safety/SKILL.md`

*[Full skill documentation in .claude/skills/typescript-type-safety/SKILL.md]*
...
These agents are converted from Cursor agents for use with Claude Code.
...
*[Full agent documentation in .claude/agents/backend-database-agent.md]*
...
**File:** `.claude/agents/content-brand-agent.md`

*[Full agent documentation in .claude/agents/content-brand-agent.md]*
...
**File:** `.claude/agents/devops-deployment-agent.md`

*[Full agent documentation in .claude/agents/devops-deployment-agent.md]*
...
**File:** `.claude/agents/frontend-development-agent.md`

*[Full agent documentation in .claude/agents/frontend-development-agent.md]*
...
**File:** `.claude/agents/full-stack-feature-agent.md`

*[Full agent documentation in .claude/agents/full-stack-feature-agent.md]*
...
**File:** `.claude/agents/testing-qa-agent.md`

*[Full agent documentation in .claude/agents/testing-qa-agent.md]*
...
- **clubhouse-patterns**: Use when: implementing clubhouse features, upload workflows, media galleries, lore stories, or club-specific functionality
- **content-moderation-trust-systems**: Use when: implementing Flow submission moderation, clubhouse upload approval workflows, building admin tools, handling edge cases in moderation, or integrating content filtering and validation
- **database-schema-migration**: Use when: adding new features requiring database changes, optimizing query performance, creating seed data for development/testing, or planning schema evolution
- **flow-feature-patterns**: Use when: implementing Flow features, vibe tag filtering, moderation queues, real-time updates, or Flow submission flows
- **framer-motion-animation**: Use when: creating scroll-triggered animations (manifesto chapters), stagger animations for lists, shared element transitions, modal/dialog transitions, Flow wall entry animations, or any motion-heavy features
- **git-workflow-conventional-commits**: Use when: setting up project Git standards, reviewing commit history, creating PR templates, configuring Husky hooks, writing commit messages, creating branches, or when the user asks about Git workflow, conventional commits, branch naming, or PR guidelines
- **nextjs-app-router-specialist**: Use when: setting up new routes and layouts, optimizing page performance, implementing SSR/SSG strategies, or debugging Next
- **runexpression-brand-voice**: Use when: writing any user-facing text, creating content, reviewing brand voice, generating seed content, or ensuring brand consistency
- **shadcn-ui-component-builder**: Use when: building new UI components, customizing existing Shadcn components, ensuring accessibility compliance, or implementing brand-specific visual patterns (sage green, purple glows, monospace fonts)
- **stripe-payment-integration**: Use when: implementing shop features, payment flows, webhook handlers, order management, digital product delivery, or debugging Stripe integration issues
- **supabase-integration-expert**: Use when: creating new database tables and policies, implementing real-time features (Flow wall updates), setting up file uploads, debugging RLS policy issues, or optimizing database queries
- **testing-qa-automation**: Use when: adding tests for new features, setting up test infrastructure, debugging test failures, or configuring CI/CD test pipelines
- **typescript-type-safety**: Use when: adding new features requiring type definitions, refactoring for better type safety, generating database types after schema changes, debugging type errors, or working with JSONB, unions, generics, or type-safe API routes

**Available Claude Skills:**
- **content-moderation-trust-systems**: Use when: implementing Flow submission moderation, clubhouse upload approval workflows, building admin tools, handling edge cases in moderation, or integrating content filtering and validation with OpenAI moderation API and trust scoring
- **database-schema-migration**: Use when: adding new features requiring database changes, optimizing query performance, creating seed data for development/testing, or planning schema evolution with hybrid relational + JSONB patterns
- **framer-motion-animation**: Use when: creating scroll-triggered animations (manifesto chapters), stagger animations for lists, shared element transitions, modal/dialog transitions, Flow wall entry animations, or any motion-heavy features
- **git-workflow-conventional-commits**: Use when: setting up project Git standards, reviewing commit history, creating PR templates, configuring Husky hooks, writing commit messages, creating branches, or when the user asks about Git workflow, conventional commits, branch naming, or PR guidelines
- **nextjs-app-router-specialist**: Use when: setting up new routes and layouts, optimizing page performance, implementing SSR/SSG strategies, debugging Next
- **shadcn-ui-component-builder**: Use when: building new UI components, customizing existing Shadcn components, ensuring accessibility compliance, or implementing brand-specific visual patterns (sage green, purple glows, monospace fonts)
- **stripe-payment-integration**: Use when: implementing shop features, payment flows, webhook handlers, order management, digital product delivery, or debugging Stripe integration issues
- **supabase-integration-expert**: Use when: creating new database tables and policies, implementing real-time features (Flow wall updates), setting up file uploads, debugging RLS policy issues, or optimizing database queries
- **testing-qa-automation**: Use when: adding tests for new features, setting up test infrastructure, debugging test failures, or configuring CI/CD test pipelines
...
- **backend-database-agent**: Backend and database specialist for API routes, database schema, Supabase integration, and RLS policies. Use proactively for backend feature development, database design and migrations, API endpoint creation, security and access control, Supabase Storage configuration, and database query optimization.
- **content-brand-agent**: Expert copywriter and brand voice specialist for RunExpression. Proactively reviews and creates all user-facing content, UI copy, seed content, blog posts, and documentation. Ensures brand voice consistency with "The Sage in the Parking Lot" philosophy. Use immediately when writing any user-facing text, creating content, or reviewing brand voice.
- **devops-deployment-agent**: DevOps and deployment specialist for Vercel deployment configuration, environment variable management, CI/CD pipeline setup, monitoring and error tracking, and performance optimization. Use proactively for deployment setup and troubleshooting, CI/CD configuration, environment management, performance monitoring, Vercel configuration, and production readiness checks.
- **frontend-development-agent**: Frontend development specialist for React components, UI/UX implementation, and client-side interactivity. Use proactively for feature development in /app and /components, UI polish and animations, form handling and validation, Flow wall components, homepage manifesto scroll experience, and real-time UI updates.
- **full-stack-feature-agent**: Full-stack feature implementation specialist for end-to-end feature development (frontend + backend). Use proactively for new feature development from scratch, major refactoring across layers, complex features requiring coordination, complete feature implementation (e.g., "Add vibe tag filtering to Flow"), integration testing, and feature documentation.
- **testing-qa-agent**: Testing and QA specialist for test writing, test infrastructure, and quality assurance. Use proactively when adding test coverage, debugging test failures, setting up test infrastructure, writing unit tests for utilities and hooks, creating component tests, setting up E2E tests with Playwright, building test data factories, or configuring CI/CD test pipelines.
...
| Date       | Changes                                      |
|------------|----------------------------------------------|
| 2026-01-23 | Regenerated with all skills, agents, and configuration files |
